          ...
          <tr>
            <td style="padding:40px 40px 16px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#6b5d4f;">
                Hey ${firstName}, we received a request to reset your password. Tap the button below to choose a new one.
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding:8px 0 24px;">
                    <a href="${resetUrl}" target="_blank" style="display:inline-block;background-color:#c2690a;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;padding:14px 36px;border-radius:10px;">
                      Reset password
                    </a>
                  </td>
                </tr>
              ...
              <p style="margin:0 0 4px;font-size:13px;line-height:1.6;color:#9b8e80;">
                This link expires in 1 hour. After resetting, all your existing sessions will be signed out for security.
              </p>
            </td>
          </tr>
