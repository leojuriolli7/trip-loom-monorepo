...
export function PersonalizeCtaCard() {
  ...
  return (
    ...
    >
      <div className="group relative flex h-full w-full min-h-50 flex-col items-center justify-center gap-3 overflow-hidden rounded-3xl border border-dashed border-primary/30 bg-gradient-to-br from-primary/8 via-card to-chart-2/10 p-6 shadow-[0_18px_30px_-28px_rgba(15,23,42,0.8)] transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/45 hover:shadow-[0_28px_40px_-24px_rgba(208,115,48,0.38)]">
        ...
        <div className="relative rounded-2xl transition-transform duration-300 group-hover:scale-105">
          <Image
            ...
            width={180}
            height={180}
            className="h-40 w-40 drop-shadow-[0_18px_18px_rgba(49,32,10,0.35)]"
          />
        </div>

        <div className="relative text-center">
          <h3 className="font-semibold tracking-tight text-foreground md:text-lg text-md transition-colors group-hover:text-primary">
            Personalize your trips
          </h3>
          <p className="mt-1 md:text-md text-sm text-muted-foreground">
            Set your travel preferences for tailored recommendations: Budget
            range, travel interests, preferred regions...
          </p>
        </div>
      </div>
    </button>
