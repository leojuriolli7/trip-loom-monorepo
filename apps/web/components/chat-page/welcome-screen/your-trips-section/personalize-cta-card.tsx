...
export function PersonalizeCtaCard() {
  ...
  return (
    ...
    >
      <div className="group relative flex h-full w-full min-h-50 flex-col items-center justify-center gap-3 overflow-hidden rounded-3xl border border-dashed border-primary/30 bg-linear-to-br from-primary/8 via-card to-chart-2/10 p-6 shadow-[0_18px_30px_-28px_rgba(15,23,42,0.8)] transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/45 hover:shadow-[0_28px_40px_-24px_rgba(208,115,48,0.38)]">
